  ...
  if("x${lang}" STREQUAL "xC" OR
    ...
    if(CMAKE_VS_PLATFORM_TOOLSET MATCHES "v[0-9]+_clang_.*")
      ...
      if(CMAKE_CL_64 OR "x${CMAKE_C_COMPILER_ID}" STREQUAL "xMSVC" OR "x${CMAKE_CXX_COMPILER_ID}" STREQUAL "xMSVC")
		...
		# Disable optimization for clang 32-bit output due to runtime issue observed in bullet3 samples (https://bugs.llvm.org/show_bug.cgi?id=41737)
        string(APPEND CMAKE_${lang}_FLAGS_RELEASE_INIT " /MD /O0 /Ob0 /DNDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_RELWITHDEBINFO_INIT " /MD /Zi /O0 /Ob0 /DNDEBUG")
        string(APPEND CMAKE_${lang}_FLAGS_MINSIZEREL_INIT " /MD /O0 /Ob0 /DNDEBUG")
      endif()
    endif()
  endif()
